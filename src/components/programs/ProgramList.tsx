        ...
        <div className="space-y-6">
          {groupedPrograms.map(([date, datePrograms]) => (
            <div key={date} className="overflow-x-auto">
              {/* 날짜 헤더 */}
              <div className="bg-gray-100 border-t-2 border-gray-300 px-4 py-2">
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200">
                    ...
                    <th className="px-4 py-2 text-left text-xs font-semibold text-gray-600 hidden md:table-cell">
                      출처
                    </th>
                    <th className="px-4 py-2 text-left text-xs font-semibold text-gray-600 hidden lg:table-cell">
                      카테고리
                    </th>
                    <th className="px-4 py-2 text-left text-xs font-semibold text-gray-600">
                      마감일
                    </th>
                    <th className="w-12 px-4 py-2 text-center text-xs font-semibold text-gray-600">
                      링크
                    </th>
                  </tr>
                </thead>
